          ...
          <>
            <Main>
              <Adverts>
                ...
                <Panel>
                  <img
                    src={advertsImages[1].image}
                    alt={advertsImages[1].name}
                  />
                  <img
                    src={advertsImages[2].image}
                    alt={advertsImages[2].name}
                  />
                  <img
                    src={advertsImages[3].image}
                    alt={advertsImages[3].name}
                  />
                  <img
                    src={advertsImages[0].image}
                    alt={advertsImages[0].name}
                  />
                  <img
                    src={advertsImages[4].image}
                    alt={advertsImages[4].name}
                  />
                </Panel>
              </Adverts>
              <ButtonsMenu>
